...
Project Description
    ...
    - The project has multiple user roles such as admin, manager, and user. 
    - Each role has different access permissions to various parts of the application. 

Requirements
    - Create a PHP script that implements user authentication and role management for Our Crew Project. 
...
How to work with data : 
    ...
    - Use File read,write,delete,append system using php
